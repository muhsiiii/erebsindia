...
<div class="layout-page">
    <div style="background-color:rgb(255, 255, 255);width:100%;height:80px;margin-bottom:20px; " class="main-nav">
                    ...
                    <div class="table-responsive text-nowrap">
                        ...
                        <table class="table">
                            ...
                            <tbody class="table-border-bottom-0">
                                ...
                                <tr>
                                    <td>{{$data->id}}</td>
                                    <td><img src="{{asset('/blog_images/'.$data->image)}}" alt="null" height="200px" width="200px"></td>                                    <td>{{$data->subject}}</td>
                                    <td>{{$data->description}}</td>

                                    <td style="display: flex;margin-top:50px;">
                                        <a href="{{route('admin.blog.edit',$data->id)}}" style="background: green;color:white;margin-right:10px;" class="btn">EDIT</a>
                                        <a href="{{route('admin.blog.delete',$data->id)}}" style="background: #dc3545;color:white;" class="btn">DELETE</a>
        ...
        <a href="{{route('admin.blog')}}" title="Add New Products">
