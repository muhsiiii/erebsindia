...
<div class="layout-page">
    <div style="background-color:rgb(255, 255, 255);width:100%;height:80px;margin-bottom:20px; " class="main-nav">
                        ...
                        <table class="table">
                            ...
                            <tbody class="table-border-bottom-0">
                                @foreach ($datas as $data)
                                    <tr>
                                        <td>{{ $data->id }}</td>
                                        <td><img src="{{asset('/projets_works_images/'.$data->image)}}" alt="null" height="200px" width="200px"></td>                                    
                                        <td>{{ $data->project_name }}</td>
                                        <td>{{ $data->description }}</td>

                                        <td style="display: flex;margin-top:10px;  padding:50px;">
                                            <a href="{{ route('admin.work.edit', $data->id) }}"
                                                style="background: green;color:white;margin-right:10px;"
                                                class="btn">EDIT</a>
                                            <a href="{{ route('admin.work.delete', $data->id) }}"
        ...
        <a href="{{ route('admin.work.form') }}" title="Add New Products">
