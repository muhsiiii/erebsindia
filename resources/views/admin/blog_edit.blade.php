                    ...
                    <div class="container my-5">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-11">
                                ...
                                <img src="{{asset('/blog_images/'.$data->image)}}" alt="null" height="250px" width="250px">
                            </div>
                        ...
                        <label for="suject" class="form-label">SUBJECT</label>
                        ...
                        <div class="dropdown show">
                            <textarea name="description" id="" cols="30" rows="10" class="form-control">{{$data->subject}}</textarea>
