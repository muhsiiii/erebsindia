    ...
    <div class="layout-wrapper layout-content-navbar  ">
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <form action="{{route('admin.our-service.save')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="container my-5">
                        ...
                        <div class="dropdown show">
                            <input type="text" class="form-control" name="service_name" placeholder="subject">
